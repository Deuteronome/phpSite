...
<body>
    <form action="../controller/addFighterController.php" method="post">
        ...
        <div id="form-line">
            <label for="power">Puissance :</label><input type="number" id="power" name="power" max="10" min="1">
        </div>

        <div id="form-line">
            <label for="resistance">Résistance :</label><input type="number" id="resistance" name="resistance" max="10" min="1">
        </div>

        <div id="form-line">
            <label for="hitpoints">Points de vie :</label><input type="number" id="hitpoints" name="hitpoints" max="30" min="1">
        </div>
