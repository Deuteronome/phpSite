    ...
    ?>
        ...
        <main>
            ...
            <div class="character-list">
                ...
                <a href="../controller/characterController.php?character=goku" class="character-card selected" id="goku" data-name="Goku">
                    
                    <p class="character-name">Goku</p>
                </a>

               <a href="../controller/characterController.php?character=freezer" class="character-card selected" id="freezer" data-name="Freezer" >
